        ...
        419: function(e, t, n) {
            e.exports = function(e) {
                ...
                function i(e) {
                    ...
                    return t.type = "text/css",
                        function(e, t) {
                            var n = p(),
                                s = h[h.length - 1];
                            if ("top" === e.insertAt) s ? s.nextSibling ? n.insertBefore(t, s.nextSibling) : n.appendChild(t) : n.insertBefore(t, n.firstChild), h.push(t);
                            else {
                ...
                function r(e, t) {
                    ...
                    if (t.singleton) {
                        var r = g++;
                        n = f || (f = i(t)), s = l.bind(null, n, r, !1), a = l.bind(null, n, r, !0)
                    } else n = i(t), s = o.bind(null, n), a = function() {
                        ! function(e) {
                ...
                e.exports = function(e, t) {
                    void 0 === (t = t || {}).singleton && (t.singleton = c()), void 0 === t.insertAt && (t.insertAt = "bottom");
                    var n = a(e);
                    return s(n, t),
                        function(e) {
                            for (var i = [], r = 0; r < n.length; r++) {
                                var l = n[r];
                                (o = u[l.id]).refs--, i.push(o)
                            }
                            for (e && s(a(e), t), r = 0; r < i.length; r++) {
                                var o;
                                if (0 === (o = i[r]).refs) {
                        ...
                        pages: function() {
                            ...
                            if (this.pageCount <= this.pageRange)
                                for (var n = 0; n < this.pageCount; n++) {
                                    ...
                                    var o = 0;
                                    this.selected - a > 0 && (o = this.selected - 1 - a);
                                    var u = o + this.pageRange - 1;
                                    u >= this.pageCount && (o = (u = this.pageCount - 1) - this.pageRange + 1);
                                    for (var d = o; d <= u && d <= this.pageCount - 1; d++) i(d);
                                    o > this.marginPages && r(o - 1), u + 1 < this.pageCount - this.marginPages && r(u + 1);
